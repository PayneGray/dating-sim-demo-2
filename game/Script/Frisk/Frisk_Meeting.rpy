...
label frisk_meeting_start:
    python:
        player.variables['has_frisk_cell'] = False #just making sure the changes stay
...
label frisk_meeting_selection13:
    menu:
        ...
        "I hate this place.":
            ...
            $world.get_monster('Toriel').update_HB(2)
            $world.get_monster('Frisk').update_HB(4)
...
label frisk_meeting_selection15:
    menu:
        ...
        "But...":                           #//(+1)
            $world.get_monster('Toriel').update_HB(1)
...
label frisk_meeting_selection19:
    ...
    menu:
        "How are you?" if chose_frisk_meeting_option40_5 == False:
...
label frisk_meeting_choice41_5:
    ...
    #scene change hallway
    $ renpy.show(world.get_room("Hallway").bg)
    jump frisk_meeting_after_dinner
